      ...
      <div className="bg-gray-50 min-h-screen w-full">
        <main className="container mx-auto px-4 py-8">
          <div className="mb-6 p-3 bg-red-50 border border-red-100 rounded-md text-red-600">
            ...
            <Link
              href="/"
              className="flex items-center mt-4 text-indigo-600 hover:text-indigo-800 transition-colors"
            >
          ...
          <div className="p-6">
            ...
            {restaurant.genre && (
              <p className="text-sm text-indigo-600 mb-6">
                {restaurant.genre.name}{" "}
                {restaurant.genre.catch && `・${restaurant.genre.catch}`}
              </p>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              {/* 左カラム: 基本情報 */}
              <div>
                <h2 className="text-xl font-semibold border-b border-gray-200 pb-2 mb-6 text-gray-800">
                  基本情報
                </h2>
